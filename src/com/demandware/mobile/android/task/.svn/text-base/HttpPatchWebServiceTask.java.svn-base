...
/**
 * This class is used to issue patch requests to the server.
 * 
 * @author mannyp
 */
public class HttpPatchWebServiceTask extends HttpGetWebServiceTask {
	/**
	 * Constructor
	 * 
	 ...
	 */
	public HttpPatchWebServiceTask(String pOperationName, Activity pActivity, Resources pResources) {
		super(pOperationName, pActivity, pResources);
	}
	
	/**
	 * Called by the base class after execute is called. Initiates the PATCH request.
	 * 
	...
	protected String doInBackground(Object... params) {
		...
		try {
	    	...
	    	return WebApi.getInstance().executeHttpPatch(url, body);
		}
		catch(IOException e) {
